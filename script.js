...
const translations = {
  es: {
    ...
    "metrics.products": "productos activos",
    "metrics.operations": "operacional",
    ...
    "testimonials.title": "Organizaciones que ya operan con KTG.",
    "testimonial.1.quote": "ChurchHub transformó cómo seguimos a nuestros miembros. Antes usábamos hojas de Excel; ahora tenemos visibilidad completa desde el primer día.",
    "testimonial.1.name": "Pastor Miguel Torres",
    "testimonial.1.org": "Iglesia Centro de Vida, Chicago IL",
    "testimonial.2.quote": "La plataforma LMS nos permitió lanzar nuestro primer programa de formación online en semanas. El equipo de KTG entendió exactamente lo que necesitábamos.",
    "testimonial.2.name": "Directora Ana Reyes",
    "testimonial.2.org": "Academia Emmanuel, Miami FL",
  ...
  en: {
    ...
    "metrics.products": "active products",
    "metrics.operations": "operational",
    "metrics.ai": "AI integrated",
    ...
    "testimonials.title": "Organizations already operating with KTG.",
    "testimonial.1.quote": "ChurchHub transformed how we follow up with our members. We used to use Excel sheets; now we have complete visibility from day one.",
    "testimonial.1.name": "Pastor Miguel Torres",
    "testimonial.1.org": "Iglesia Centro de Vida, Chicago IL",
    "testimonial.2.quote": "The LMS platform let us launch our first online training program in weeks. The KTG team understood exactly what we needed.",
    "testimonial.2.name": "Director Ana Reyes",
    "testimonial.2.org": "Academia Emmanuel, Miami FL",
